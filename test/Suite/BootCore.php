...
class_alias(Core\Boot::class,Test\Suite\BootAlias::class);
...
class BootCore extends Test\Suite\BootAlias
{
    ...
    protected static array $config = [
        ...
        'dbOption'=>[
            'tables'=>[
                'ormTable'=>['test'=>'ok']],
            'cols'=>[
                'name_fr'=>['required'=>true,'general'=>true],
                'name_en'=>['required'=>true,'general'=>true],
    ...
    protected function onReady():void
    {
        ...
        $session->setLang('en');
        $lang->replace($en);
        $array = ['relation/contextType/assert'=>'Assertion script'];
        $lang->replace($array);

        $tables = $this->db()->tables();
        $permission = $this->getAttr('assert/tablePermission');
        foreach ($permission as $role => $array)
        {
    ...
    final protected static function assertCommon64():array
    {
        return [
            ...
            'en.php' => '',
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Assert",'Priority',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Col",'OrmCell__Name',function() {
...
class OrmCell__Name extends Core\ColAlias
{
    ...
    // onSet
    public function onSet($return,?Orm\Cell $cell,array $row,array $option)
    {
        if(is_string($return))
    ...
    // onGet
    public function onGet($return,?Orm\Cell $cell,array $option)
    {
        if(is_scalar($return))
        $return .= 'abcde';
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Col",'UserIds',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Row",'OrmCell',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Row",'OrmRow',function() {
...
class OrmRow extends Core\RowAlias
{
    ...
    protected static array $config = [
        ...
        'order'=>['date'=>'desc'],
        '@assert'=>[
            'route'=>['priority'=>Suite\Assert\Priority::class]
        ]
    ];
}
});
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Row",'OrmTableSibling',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Rows",'OrmDb',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Table",'OrmDb',function() {
...
\Quid\Main\Autoload::setClosure("Quid\Test\Suite\Table",'OrmTable',function() {
