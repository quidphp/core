...
class BootCore extends Test\Suite\BootAlias
{
	...
	public static $config = [
		...
		'assert'=>[
			...
			'overview'=>1,
			'db'=>null,
			'exclude'=>array(\Quid\Lemur::class,\Quid\Site::class),
		...
		'dbOption'=>[
			'tables'=>[
				'ormTable'=>['test'=>'ok']],
			'cols'=>[
                'name_fr'=>array('required'=>true,'general'=>true),
                'name_en'=>array('required'=>true,'general'=>true),
		...
		'service'=>array(
			'ldap'=>array(Core\Service\Ldap::class,array('host'=>'james.com','port'=>388)),
			'mailer'=>array(Core\Service\PhpMailer::class,array('host'=>'smtp.james.com','port'=>587,'encryption'=>'tls','username'=>'james@james.com','password'=>'james','name'=>'James'))),
        'roles'=>array(
            'user'=>array(20)),
        '@dev'=>[
			'callable'=>[
