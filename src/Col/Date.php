...
class Date extends Core\ColAlias
{
    ...
    public static $config = [
        ...
        'tag'=>'inputText',
        'filter'=>true,
        'filterMethod'=>array(self::class,'autoFilterMethod'),
        'date'=>'dateToDay',
        'pattern'=>false,
        'onComplex'=>true,
        'check'=>['kind'=>'int'],
        'calendarFormat'=>'dateToDay', // custom
        'filterFormat'=>array( // format, méthodes et maximum pour le filter
            'day'=>array('format'=>0,'filter'=>'or|day','method'=>'days','max'=>100),
            'month'=>array('format'=>2,'filter'=>'or|month','method'=>'months','max'=>1500),
            'year'=>array('format'=>'Y','filter'=>'or|year','method'=>'years')), 
