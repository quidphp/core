    ...
    public static $config = [
        'option'=>[ // tableau d'options
            ...
            'cols'=>[ // paramètre par défaut pour les colonnes
                ...
                'storage'=>['class'=>Col\Media::class,'path'=>'[storagePrivate]/storage','extension'=>'pdf'],
                'storage_fr'=>['class'=>Col\Media::class,'panel'=>'fr','path'=>'[storagePrivate]/storage','extension'=>'pdf'],
                'storage_en'=>['class'=>Col\Media::class,'panel'=>'en','path'=>'[storagePrivate]/storage','extension'=>'pdf'],
                'storages'=>['class'=>Col\Medias::class,'path'=>'[storagePrivate]/storage','extension'=>'pdf'],
